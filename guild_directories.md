Guild directories are a special type of channel that serve as directories for servers. They are locked behind the `HUBS` guild feature and are (currently) accessable through the "School Hubs" experiment
