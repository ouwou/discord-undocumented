...
Undocumented fields for [ApplicationCommand](#https://discord.com/developers/docs/interactions/slash-commands#applicationcommand)

| Field | Type | Description |
|-------
| version | snowflake | unknown
| permission | array of [ApplicationCommandPermissions](#https://discord.com/developers/docs/interactions/slash-commands#applicationcommandpermissions) (probably) | permissions for the command |
